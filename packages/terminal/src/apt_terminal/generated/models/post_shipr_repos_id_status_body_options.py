...
T = TypeVar("T", bound="PostShiprReposIdStatusBodyOptions")


@_attrs_define
class PostShiprReposIdStatusBodyOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_shipr_repos_id_status_body_options = cls(
            sha=sha,
        ...
        post_shipr_repos_id_status_body_options.additional_properties = d
        return post_shipr_repos_id_status_body_options
