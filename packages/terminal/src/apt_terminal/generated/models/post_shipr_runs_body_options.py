...
T = TypeVar("T", bound="PostShiprRunsBodyOptions")


@_attrs_define
class PostShiprRunsBodyOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_shipr_runs_body_options = cls(
            sha=sha,
            shard=shard,
            group_id=group_id,
        )

        post_shipr_runs_body_options.additional_properties = d
        return post_shipr_runs_body_options
