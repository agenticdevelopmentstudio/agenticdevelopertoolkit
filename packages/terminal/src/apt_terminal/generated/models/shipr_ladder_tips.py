...
T = TypeVar("T", bound="ShiprLadderTips")


@_attrs_define
class ShiprLadderTips:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shipr_ladder_tips.additional_properties = additional_properties
        return shipr_ladder_tips
