...
T = TypeVar("T", bound="PostShiprReposIdPrepareBodyOptions")


@_attrs_define
class PostShiprReposIdPrepareBodyOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_shipr_repos_id_prepare_body_options = cls(
            sha=sha,
            shard=shard,
            group_id=group_id,
        )

        post_shipr_repos_id_prepare_body_options.additional_properties = d
        return post_shipr_repos_id_prepare_body_options
